...
# Use the modern DataLoader from `torch_geometric.loader` instead of the
# deprecated `torch_geometric.data.DataLoader`.
...
def main():
    ...
    # Default target is set to 7 (atomic energy) as an integer.  Passing a
    # string here can cause type inference issues when parsing arguments.
